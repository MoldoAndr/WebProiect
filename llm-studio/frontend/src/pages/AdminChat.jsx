...
const mockAdminChats = [
  {
    ...
    messages: [
      ...
      },
      {
        id: 2,
        role: "admin",
        content: "Hello! I'd be happy to help with your billing inquiry. Could you please provide your account email and the date of the charge you're inquiring about?",
    ...
    messages: [
      {
        id: 3,
        role: "user",
        content: "I would like to suggest adding a dark mode to the application.",
        created_at: "2025-03-08T09:15:00Z",
      },
      {
        id: 4,
        role: "admin",
        content: "Thank you for your suggestion! We're actually working on implementing dark mode in our next release. Would you like to join our beta testing program to try it out early?",
    ...
    messages: [
      {
        id: 5,
        role: "user",
        content: "I'm experiencing slow response times when using the GPT-4 model.",
        created_at: "2025-03-05T16:45:00Z",
      },
      {
        id: 6,
        role: "admin",
        content: "I'll look into this for you. Can you tell me what time of day you're experiencing the slowdowns?",
      ...
      },
      {
        id: 8,
        role: "admin",
        content: "Thanks for the information. We've identified a performance issue during peak hours and have applied a fix. Please let us know if you continue to experience any slowdowns.",
      ...
      },
      {
        id: 10,
        role: "admin",
        content: "Excellent! I'm glad to hear that. I'll be closing this ticket, but please don't hesitate to reach out if you have any other questions or concerns.",
              ...
              <div className="admin-chat-input">
                {selectedTicket.status === "closed" ? (
                  <div className="ticket-closed-message">
                    ...
                    <span>This ticket is closed. Please create a new ticket if you need further assistance.</span>
                  </div>
                ) : (
                  <>
                    <textarea
